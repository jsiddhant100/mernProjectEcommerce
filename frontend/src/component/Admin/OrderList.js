...
import { deleteOrder, setIsDeleted, STATUSES as deleteStatus, clearError as stopError } from "../../store/deleteUpdateOrderSlice";
import { getAllOrders, STATUSES, clearError } from "../../store/allOrdersSlice";
